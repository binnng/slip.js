...
(function(WIN, DOC) {
  ...
  Slip = (function() {
    ...
    function Slip(ele, direction) {
      ...
      this.coord = this.eventCoords = this.cacheCoords = this.eventMove = this.absEventMove = null;
      this.orient = [];
    }
    ...
    Slip.prototype.onTouchStart = function(event) {
      ...
      this.eventMove = this.absEventMove = null;
    ...
    Slip.prototype.onTouchMove = function(event) {
      ...
      absEventMove = this.absEventMove = {
    ...
    Slip.prototype.onTouchEnd = function(event) {
      var absEventMove, defaultMove, ele, eventMove, orient;
      ele = this.ele;
      defaultMove = {
        "x": 0,
        "y": 0
      };
      eventMove = this.eventMove || defaultMove;
      absEventMove = this.absEventMove || defaultMove;
      orient = [];
      if (absEventMove.x > MIN_ALLOW_DISTANCE) {
        orient.push(eventMove.x < 0 ? LEFT : RIGHT);
      }
      if (absEventMove.y > MIN_ALLOW_DISTANCE) {
        orient.push(eventMove.y < 0 ? UP : DOWN);
      }
      this.orient = orient;
